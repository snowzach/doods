...
FROM ubuntu:18.04
RUN apt-get update && apt-get install -y --no-install-recommends libusb-1.0 libc++-7-dev libgtk2.0-0 libdc1394-22 libavcodec57 libavformat57 ffmpeg wget unzip
